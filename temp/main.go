...
func main() {
	// 연결하는 과정
	client, err := ethclient.Dial("https://api.test.wemix.com") // 그대로 사용
	if err != nil {
		panic(err)
	}
	firstAddress := common.HexToAddress("0x406A1Ee747CEEA7a8819Bb999c3B24cc88000461") // 서버 계정 주소 이녀석은 toml에서 가져와야 함

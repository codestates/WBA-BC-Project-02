...
// // 이녀석은 현재 알 수 없는 이유로 revert됨 .... 진짜 할 수 있는 최선을 다해 분석했는데 ㅠ
...
// 	auth, err := bind.NewKeyedTransactorWithChainID(firstPk, chainID)
// 	if err != nil {
// 		fmt.Println(err)
// 	}

// 	tx, err := instance.SubmitTransaction(auth, destinationContractAddr, big.NewInt(0), GetDestinationfuncData())
// 	if err != nil {
// 		fmt.Println(err)
// 	}
